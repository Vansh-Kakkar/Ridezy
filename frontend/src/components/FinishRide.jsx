...
const FinishRide = ({setFinishRidePopupPanel,ride}) => {
  ...
  return (
    <div>
             <h5 onClick={()=> setFinishRidePopupPanel(false)} className='p-1 text-center w-[93%] absolute top-0 '> <RiArrowDownWideLine className='text-3xl text-gray-200'/> </h5>
                     ...
                     <div className='flex gap-2 justify-between flex-col items-center'>
                        ...
                        <div className='mt-10 w-full'>
                                 ...
                                 <button to='/captain-home' onClick={endRide} className='w-full mt-5 flex text-lg justify-center bg-green-600 text-white font-semibold p-3 rounded-lg'>Finish Ride</button>
