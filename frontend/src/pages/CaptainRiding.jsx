...
const CaptainRiding = () => {
  ...
  return (
    <div className='h-screen relative'>
        ...
        <div className='h-1/5 p-6 flex items-center justify-between relative bg-yellow-400' onClick={()=> setFinishRidePopupPanel(true)}>
        ...
        <div ref={finishRidePopupPanelRef} className='fixed w-full z-10 bottom-0 translate-y-full bg-white px-3 py-10 pt-12'>
