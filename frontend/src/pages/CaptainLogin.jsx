...
const CaptainLogin = () => {
   ...
   const [email,setEmail] = useState('')
    ...
    const submitHandler = async(e)=> {
          e.preventDefault()
          const updatedCaptain = {email,password}
         

          const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/captains/login`,updatedCaptain)
  ...
  return (
     <div className='p-7  h-screen flex flex-col justify-between'>
       ...
       <form onSubmit={(e) => submitHandler(e)}>
         ...
         <p className='text-center'>Offer rides? <Link to= '/captain-signup' className='text-blue-600'>Register as a captain</Link></p>
       </div>
       <div>
