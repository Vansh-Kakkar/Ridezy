...
const CaptainSignup = () => {
   const [email,setEmail] = useState('')
    ...
    const submitHandler = (e)=> {
       ...
       const updatedCaptain = {fullName,email,password}
  ...
  return (
     <div className='py-5 px-5  h-screen flex flex-col justify-between'>
       ...
       <div>
         <p className='text-sm leading-tight'>By Proceeding you consent to get mails, including by automated means, from Ridezy to the email provided.</p>
       </div>
    </div>
  )
}
